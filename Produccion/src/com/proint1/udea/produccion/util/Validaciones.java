...
public class Validaciones {
	...
	/**
	 * Valida que el correo electrónico establecido como parámetro sea un correo
	 * electrónico con formato válido
	 * 
	 * @param correo
	 *            texto con el correo electrónico a validar
	 * @return true si el texto tiene un formato de correo electrónico válido,
