...
//		 boolean transaccion =
//		 autorService.insertar(tipoId,txtNumeroId.getText(),txtApellidos.getText(),
...
//		byte[] foto = convertirEnArregloDeByte(imagen);
	...
	// private byte[] convertirEnArregloDeByte(Media media2) {
	// File file = new File(media2.get);
...
//	}
	...
	private void cargarTipoDocumentos() throws ProduccionIWException {
		try {
			...
			throw new ProduccionIWException(
					"No se pudo cargar los tipos de identificación");
		}
	}
